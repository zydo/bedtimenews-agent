...
| 目录          | 节目名称   | 集数（截至2025年11月） | 主要话题                 |
| ------------- | ---------- | ---------------------- | ------------------------ |
| `main/`       | 睡前消息   | 900+                   | 全面覆盖所有主题         |
| `reference/`  | 参考信息   | 600+                   | 每日新闻聚合             |
| `business/`   | 产经破壁机 | 86                     | 经济、产业、商业、技术   |
| `commercial/` | 讲点黑话   | 66                     | 国际关系、地缘政治       |
| `opinion/`    | 高见       | 51                     | 技术分析、基础设施、工程 |
